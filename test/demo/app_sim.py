...
# Add this after the KPI row
if prediction == 1:
    st.error(f"⚠️ **Action Required:** This customer is likely to leave. Send a **{np.random.randint(10, 25)}% discount code** to their email immediately!")
else:
    st.success("✅ **Status:** This is a healthy customer. No intervention needed.")
...
with col_right:
    st.subheader("🎁 Recommended Next Best Products")
